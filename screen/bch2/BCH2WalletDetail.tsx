    ...
    return (
      <TouchableOpacity style={styles.txItem}>
        <View style={styles.txLeft}>
          <View style={[styles.txIcon, { backgroundColor: isReceived ? BCH2Colors.success : BCH2Colors.error }]}>
            <Text style={styles.txIconText}>{isReceived ? '↓' : '↑'}</Text>
          </View>
        ...
        <View style={styles.txRight}>
          ...
          <Text style={styles.txConfirmations}>
            {item.confirmations > 0 ? `${item.confirmations} conf` : 'Pending'}
          </Text>
        </View>
      </TouchableOpacity>
    );
