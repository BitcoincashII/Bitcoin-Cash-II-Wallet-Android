...
const defaultPeer: Peer = { host: '144.202.73.66', ssl: 50002, tcp: 50001 };
export const hardcodedPeers: Peer[] = [
  // Primary BCH2 Electrum server (pool server with patched Fulcrum)
  { host: '144.202.73.66', ssl: 50002, tcp: 50001 },
  // Future additional servers
  { host: 'electrum.bch2.org', ssl: 50002 },
