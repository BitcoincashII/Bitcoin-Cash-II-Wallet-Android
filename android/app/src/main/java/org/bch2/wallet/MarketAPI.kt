...
object MarketAPI {
    ...
    suspend fun fetchNextBlockFee(context: Context): String {
        ...
        try {
            ...
            try {
                ...
                Log.i(TAG, "Successfully calculated next block fee: $formattedFee sat/byte")
                return formattedFee
            } catch (e: Exception) {
     ...
     * @return the fee rate in sat/byte that would get confirmed in the target number of blocks
     */
